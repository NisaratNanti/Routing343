...
export default function Create({ departments }) { // สร้างฟังก์ชัน Create และรับ departments มาจาก Controller
    const { data, setData, post, errors } = useForm({    //การสร้างข้อมูล
        first_name: '',
        last_name: '',
        birth_date: '',
    ...
    return (    //หน้ากรอกข้อมูล และ ปุ่ม 
...
// ปุ่มสำหรับส่งข้อมูลไปยัง EmployeeController/store