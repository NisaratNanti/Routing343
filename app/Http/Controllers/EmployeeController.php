...
class EmployeeController extends Controller
{
    public function index(Request $request)
    {
        ...
        $employees = DB::table("employees")
            ->where(function ($q) use ($query) { // ค้นหาข้อมูลจากชื่อ, นามสกุล หรือรหัสพนักงาน
        ...
        return Inertia::render('Employee/Index', [ // ส่งข้อมูลไปยังหน้า Inertia
            'employees' => $employees,
            'query' => $query,
            'sort' => $sort,
            'direction' => $direction,
     ...
     */
    public function create() // สร้างฟังก์ชันสำหรับแสดงหน้าแบบฟอร์มสำหรับเพิ่มข้อมูลพนักงาน
    {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return back()->with('error', 'Failed to create employee. Please try again.'); // แจ้งเตือนเมื่อเกิดข้อผิดพลาด
